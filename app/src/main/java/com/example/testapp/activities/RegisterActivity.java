...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        user.put(Constants.KEY_NICKNAME, binding.inputNickname.getText().toString());
    ...
    private Boolean isValidSignUpDetails() {
        if (encodedImage == null) {
            ...
            return false;
        } else if (binding.inputNickname.getText().toString().trim().isEmpty()) {
            ...
            showToast("Введите настоящий Email");
            return false;
    ...
    private void loading(Boolean isLoading) {
        if (isLoading) {
            binding.regbutton.setVisibility(View.INVISIBLE);
            binding.progressBar.setVisibility(View.VISIBLE);
        } else {
            binding.regbutton.setVisibility(View.VISIBLE);
